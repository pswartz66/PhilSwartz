...
const BackCardPF = (props) => {
    ...
    return (
        <div onClick={props.onClick} className="back-items-pf">
            <h6>Code snippets from the project</h6>
            <br></br>
            <pre className="back-comment-pf">{"// Animation when page loads using \n// styled components"}</pre>
            <pre>{sampleString}</pre>
            <br></br>
            <pre className="back-comment-pf">{"// Smooth scroll to new section \n// using Link from react-scroll lib"}</pre>
